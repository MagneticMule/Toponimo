	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAddWordButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(WordBankActivity.this, PlaceListActivity.class);
				startActivity(i);
			}
		});
		...
		RelativeLayout profileHeader = (RelativeLayout) inflater.inflate(R.layout.timeline_header, null);
