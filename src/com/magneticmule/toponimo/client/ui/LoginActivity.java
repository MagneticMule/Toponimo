...
public class LoginActivity extends Activity {
	...
	userDetailsPrefs = getSharedPreferences(USER_DETAILS_PREFS, 0);
	...
	loginButton.setOnClickListener(new View.OnClickListener() {
		...
		if (HttpUtils.isOnline(getApplicationContext())) {
		    if (username.length() != 0 && !(userPassword.length() < 4)) {
	...
	protected UserDetails doInBackground(Object... arg0) {
		...
		if (httpCode == 200) {
		    ...
		    // Store the user details in a shared preferences file
